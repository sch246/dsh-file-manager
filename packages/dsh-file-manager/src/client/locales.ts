...
export type FileManagerLocaleKey =
  ...
  | 'downloadHint' | 'refreshFailed' | 'upload' | 'download' | 'dropUpload' | 'dropUnavailable' | 'dropDestination'
...
export const en: Record<FileManagerLocaleKey, string> = {
  ...
  upload: 'Upload files',
  download: 'Download',
  downloadHint: 'Download (hold Shift for ordinary browser download)',
...
export const zh: Record<FileManagerLocaleKey, string> = {
  ...
  upload: '上传文件',
  download: '下载',
  downloadHint: '下载（按住 Shift 使用普通浏览器下载）',
