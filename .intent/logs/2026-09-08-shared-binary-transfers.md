...
Manager delegates binary HTTP transport to user-files ^0.1.10. It retains upload batches, destination selection, browser download handoff and optional drop UI. Removed its Host route, transfer configuration and WebServer dependency.
